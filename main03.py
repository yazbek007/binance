...
class TradingState:
    ...
    def add_signal(self, symbol: str, signal_type: str, strength: int, price: float, confidence: str):
        ...
        self.performance_stats['last_signal_time'] = datetime.utcnow()
            ...
            for symbol in state.symbols:
                try:
                    ...
                    with state.lock:
                        ...
                        state.market_data[symbol].last_update = datetime.utcnow()
        ...
        <div class="container">
            <div class="header">
                ...
                <p style="margin-top: 10px; color: #666;">
                    ...
                    Bot Running: {(datetime.utcnow() - perf['bot_start_time']).days} days
                </p>
            </div>
    ...
    <body>
        <div class="container">
            ...
            <div style="margin-top: 30px; padding: 20px; background: #f8f9fa; border-radius: 8px;">
                ...
                <p><strong>Last Analysis:</strong> {datetime.utcnow().strftime('%H:%M:%S UTC')}</p>
            </div>
        </div>
    </body>
    </html>
